...
#nav li a.arrow {background-image: (images\images.jpg) }
...
#nav .no-click {cursor: default}

#nav li a {margin: -1px -1px 0 0}

#nav li li a {margin: 0 0 -1px}

#nav > li > .arrow {padding-right: 12px}

#nav ul .arrow-pad > li > a {padding-right: 11px}
